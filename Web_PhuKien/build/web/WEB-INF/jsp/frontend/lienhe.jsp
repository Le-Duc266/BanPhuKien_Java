    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5">
            <div class="col-lg-7 mb-5">
                <div class="contact-form">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate="novalidate">
                        ...
                        <div class="control-group">
                            <textarea class="form-control" rows="6" id="message" placeholder="Lời thắc mắc"
                                required="required"
            ...
            <div class="col-lg-5 mb-5">
                ...
                <p>Với bất kì thắc mắc nào chúng tôi sẽ cố gắng giải quyết nhanh nhất để hỗ trợ bạn. Cảm ơn bạn đã liên hệ đến chúng tôi.</p>
