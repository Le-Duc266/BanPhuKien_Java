        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center py-3 px-xl-5">
                ...
                <div class="col-lg-3 col-6 text-right">
                    ...
                    <a href="gio-hang" class="btn border gio-hang" >
                    ...
                    <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                <a href="/Web_PhuKien/" class="nav-item nav-link">Trang chủ</a>
        ...
        <div class="container-fluid py-5">
            <div class="row px-xl-5">
                    ...
                    <div id="product-carousel" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner border">
                            <div class="carousel-item active">
                                <img class="w-100 h-100" src="/Web_PhuKien/resources/images/product/${s.anh}" id="anh" alt="Image">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-7 pb-5">
                    <input type="text" class="form-control bg-secondary text-center soluong " id="masp" hidden="true" value="${s.maSanPham}">
                    <h3 class="font-weight-semi-bold tensp">${s.tenSanPham}</h3>
                    <h3 class="font-weight-semi-bold mb-4 gia"><fmt:formatNumber value = "${s.gia}" type = "currency"/></h3>
                    <p class="mb-4">${s.moTa}</p>
                    <div class="d-flex align-items-center mb-4 pt-2 ">
                        <div class="input-group quantity mr-3" style="width: 130px;">
                            ...
                            <input type="text" class="form-control bg-secondary text-center soluong " id="soluong" value="1">
                            <div class="input-group-btn">
                        ...
                        <button type="button" class="btn btn-primary px-3 giohang"><i class="fa fa-shopping-cart mr-1"></i>Giỏ Hàng</button>
                    </div>
            ...
            $(".giohang").click(function () {
                ...
                $.ajax({
                    ...
                    success: function (value) {
                        if (!value.result) {
                            toastr.success('Thêm sản phẩm thành công', 'Success!', {closeButton: true,
                                tapToDismiss: false});
                        } else {
                            toastr.error('Thêm sản phẩm thất bai!', 'Error!');
                        }
