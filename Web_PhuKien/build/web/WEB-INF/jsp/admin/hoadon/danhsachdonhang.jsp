                        ...
                        <div class="content-wrapper">
                            ...
                            <div class="row">
                                <div class="col-lg-12 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Đơn Hàng Chờ Duyệt</h4>
                                                ...
                                                <table id="sanpham" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <c:forEach var="c" items="${hd}">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="/Web_PhuKien/admin/hoadon/chitiethodon?maHoaDon=${c.maHoaDon}"><button type="button" class="btn btn-inverse-info btn-fw" >Chi tiết</button></a>
                                                                <a>
                                                                    <button type="button" class="btn btn-inverse-success btn-fw duyet" style="width: 90px">
