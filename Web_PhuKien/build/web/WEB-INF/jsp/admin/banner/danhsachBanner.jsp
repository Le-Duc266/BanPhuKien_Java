                        ...
                        <div class="content-wrapper">
                                ...
                                <div class="col-md-6 grid-margin ">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form class="forms-sample" action="/Web_PhuKien/admin/banner/luuBanner" method="POST" enctype="multipart/form-data" >
                                                <input hidden name="maBanner" id="maBanner" value="0"/>
                                                <div class="form-group">
                                                    <label>File upload</label>

                                                    <div class="input-group col-xs-12">
                                                        <input type="file" name="anhBannerURL" id="anh" class="form-control filestyle" accept="image/png, image/jpeg">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    ...
                                                    <c:forEach var="bn" items="${bn}">
                                                        <tr>
                                                            <td>${bn.maBanner}</td>
                                                            <td class="font-weight-bold"><img class="product-img" src="<i:url value='/resources/images/banner/${bn.anh}'/>" width="100"/></td>
                                                            <td>${bn.vitri}</td>
                                                            <td>
                                                                <a data-toggle="modal" data-target="#deleteAnhModal">
                                                                    <button type="button" class="btn btn-danger  btn-icon getanh" data-tenanh="${bn.anh}" data-mabanner="${bn.maBanner}">
                                                                        Xóa
                                                                    </button>
                                                                </a>
                                                            </td>
                            ...
                            <div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <form action="/Web_PhuKien/admin/banner/xoaBanner" method="post">
