                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="tenSanPham" value="${s.tenSanPham}" class="form-control"  placeholder="Tên sản phẩm"  />
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="number" name="gia" value="${s.gia}" class="form-control"  placeholder="Giá sản phẩm"  />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="number" name="soLuong" value="${s.soLuong}" class="form-control"  placeholder="Số Lượng"  />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
