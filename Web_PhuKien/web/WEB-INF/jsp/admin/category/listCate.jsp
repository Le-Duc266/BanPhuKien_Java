                                ...
                                <div class="col-md-6 grid-margin ">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form class="forms-sample" action="/Web_PhuKien/admin/category/saveCate" method="POST" onsubmit="return validate()" >
                                                    ...
                                                    <c:forEach var="s" items="${danhmuc}">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="deleteCate.htm?id=${s.maDanhMuc}" onclick="return confirm('Ban chac chan muon xoa?')"><button type="button" class="btn btn-danger btn-rounded btn-fw" >Xóa</button></a>
                                                            </td>
                                                        </tr>
